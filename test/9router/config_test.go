...
// Config holds 9router characterize-suite provider settings (env, paths, defaults).
type Config struct {
	Name                   string
	DisplayName            string
	GateEnv                string
...
// provider is the 9router characterize config for this package.
var provider = Config{
	Name:                   "9router",
	DisplayName:            "9router",
	GateEnv:                "SAPALOQ_9ROUTER_CHARACTERIZE_E2E",
	CredEnv:                "NROUTER_API_KEY",
	ModelsEnv:              "NROUTER_MODELS",
	EndpointEnv:            "NROUTER_ENDPOINT",
	DefaultEndpoint:        "http://127.0.0.1:20128/v1/chat/completions",
	TmpSubdir:              "9router",
	DocKeyPrefix:           "9router",
	ConfigKeyPrefix:        "9router",
	CredentialsEnvDefault:  "NROUTER_API_KEY",
	CredentialsEnvOverride: "NROUTER_CREDENTIALS_ENV",
	MakeTarget:             "9router-characterize",
	TestDir:                "test/9router",
