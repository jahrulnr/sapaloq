...
func blackboxEnabled() bool { return provider.enabled() }

func blackboxAPIKey() string { return provider.apiKey() }

func blackboxEndpoint() string { return provider.endpoint() }

func requireBlackboxModels(t *testing.T) []ModelSpec {
	return provider.requireModels(t)
}

func blackboxRawDir(t *testing.T) string { return provider.tmpDir(t) }

func blackboxRawPath(t *testing.T, model string, stream StreamMode) string {
	return provider.rawPath(t, model, stream)
}

func blackboxTranscriptPath(t *testing.T, model string, stream StreamMode) string {
