...
Imagine your image's color distribution as a pyramid:

```
        /\          ← Accent (smallest area, highest intensity)
       /  \
      /    \        ← Saturated colors (small area)
     /      \
    /        \      ← Mid-tones / local colors (medium area)
   /          \
  /            \    ← Neutrals & near-neutrals (LARGEST area)
 /______________\
```
...
> "This is one of these fundamental ideas... often there are counterintuitive things that happen."
...
- **Free illustration workshop:** https://www.thedrawingYou.com/illustrationworkshop
- **Tim McBurnie portfolio:** https://www.timmcburnie.com
