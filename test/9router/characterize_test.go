...
// TestCharacterizeNonNativeToolRoundTrip probes 9router chat/completions directly
...
//
// Gated: SAPALOQ_9ROUTER_CHARACTERIZE_E2E=1 + NROUTER_API_KEY + NROUTER_MODELS.
func TestCharacterizeNonNativeToolRoundTrip(t *testing.T) {
	specs := requireNrouterModels(t)
