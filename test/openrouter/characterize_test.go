...
// TestCharacterizeNonNativeToolRoundTrip probes OpenRouter chat/completions directly
...
//
// Gated: SAPALOQ_OPENROUTER_E2E=1 + OPENROUTER_API_KEY + OPENROUTER_MODELS.
func TestCharacterizeNonNativeToolRoundTrip(t *testing.T) {
	specs := requireOpenRouterModels(t)
