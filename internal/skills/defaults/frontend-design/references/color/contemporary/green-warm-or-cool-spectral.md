...
**Date:** 2025-06-17
**URL:** https://www.youtube.com/shorts/WQYLfwa2lAI
**Views:** 110,515

## Description

A spectral reflectance explanation of warm vs. cool colors, and why green (and purple) are fundamentally neither.
...
Something with an imbalance of reflection is going to look warm if it's shaped like this. This is orange. If it moves over, it becomes yellow. If it keeps moving over, it gets brighter and brighter until it fades to white. If it keeps moving the other direction, it gets redder and redder until it fades to black. Those are our warm colors.
