...
func openRouterEnabled() bool { return provider.enabled() }

func openRouterAPIKey() string { return provider.apiKey() }

func openRouterEndpoint() string { return provider.endpoint() }

func requireOpenRouterModels(t *testing.T) []ModelSpec {
	return provider.requireModels(t)
}

func openRouterRawDir(t *testing.T) string { return provider.tmpDir(t) }
